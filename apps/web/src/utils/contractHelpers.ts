...
import {
  getAddress,
  getRoshiniProfileAddress,
  getRoshiniBunniesAddress,
...
import roshiniBunniesAbi from 'config/abi/roshiniBunnies.json'
...
import roshiniSquadAbi from 'config/abi/roshiniSquad.json'
...
export const getProfileContract = (signer?: Signer | Provider) => {
  return getContract({ abi: profileABI, address: getRoshiniProfileAddress(), signer }) as RoshiniProfile
}
export const getRoshiniBunniesContract = (signer?: Signer | Provider) => {
  return getContract({ abi: roshiniBunniesAbi, address: getRoshiniBunniesAddress(), signer }) as RoshiniBunnies
}
...
export const getRoshiniSquadContract = (signer?: Signer | Provider) => {
  return getContract({ abi: roshiniSquadAbi, address: getRoshiniSquadAddress(), signer }) as RoshiniSquad
}
