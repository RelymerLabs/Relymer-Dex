...
import IRoshiniRouter02ABI from 'config/abi/IRoshiniRouter02.json'
import { IRoshiniRouter02 } from 'config/abi/types/IRoshiniRouter02'
import {
...
export function useRouterContract() {
  ...
  return useContract<IRoshiniRouter02>(ROUTER_ADDRESS[chainId], IRoshiniRouter02ABI, true)
}
