...
export const DEFAULT_META: PageMeta = {
  title: 'RelymerDex',
  description:
    'The most popular AMM on BSC by user count! Earn CAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by RelymerDex), NFTs, and more, on a platform you can trust.',
  image: 'localhost:3000/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for RelymerDex exchanges.' },
      '/info/pairs': { title: t('Pairs'), description: 'View statistics for RelymerDex exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for RelymerDex exchanges.' },
      '/nfts/collections': { basePath: true, title: t('Collections') },
      '/nfts/activity': { title: t('Activity') },
      '/profile': { basePath: true, title: t('Profile') },
      '/roshiniswap-squad': { basePath: true, title: t('RelymerDex Squad') },
      '/pottery': { basePath: true, title: t('Pottery') },
    },
    defaultTitleSuffix: t('RelymerDex'),
  }
}
