  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/dapp/app.RelymerDex.com/',
      qrCode,
      downloadLink: 'https://metamask.app.link/dapp/app.RelymerDex.com/',
    },
    {
      id: 'binance',
    ...
    },
    {
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=localhost:3000/',
      downloadLink: {
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://docs.app.RelymerDex.com/v/${docLangCodeMapping[code]}/get-started/wallet-guide`
    : `https://docs.app.RelymerDex.com/get-started/wallet-guide`
