...
const useGetTopFarmsByApr = (isIntersecting: boolean) => {
  ...
  const { data: farms, oscarPerSec } = useFarms()
  ...
  useEffect(() => {
    const getTopFarmsByApr = (farmsState: DeserializedFarm[]) => {
      ...
      const farmsWithApr: FarmWithStakedValue[] = farmsWithPrices.map((farm) => {
        ...
        const { monkRewardsApr, lpRewardsApr } = getFarmApr(
          chainId,
          farm.poolWeight,
          cakePriceBusd,
          totalLiquidity,
        ...
        return { ...farm, apr: monkRewardsApr, lpRewardsApr }
      })
  ...
  }, [setTopFarms, farms, fetchStatus, cakePriceBusd, topFarms, oscarPerSec, chainId])
