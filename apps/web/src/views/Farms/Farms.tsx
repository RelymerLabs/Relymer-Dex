...
import { getFarmApr, getFarmAprLocal } from 'utils/apr'
...
const Farms: React.FC<React.PropsWithChildren> = ({ children }) => {
  ...
  const { data: farmsLP, userDataLoaded, poolLength, oscarPerSec } = useFarms()
  // console.log(farmsLP)
  ...
  const farmsList = useCallback(
    (farmsToDisplay: DeserializedFarm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        // console.log("farm", totalLiquidity.toString())
        // const { monkRewardsApr, lpRewardsApr } = isActive
        //   ? getFarmApr(
        //       chainId,
        ...
        //       oscarPerSec,
        //     )
        //   : { monkRewardsApr: 0, lpRewardsApr: 0 }
        // console.log(farm.quoteTokenPriceBusd)
  // cakePriceUsd: BigNumber,
        // console.log(oscarPerSec)
        // console.log('config', chainId, farm.lpAddress, totalLiquidity,farm.tokenPriceBusd, farm.quoteTokenPriceBusd, oscarPerSec)
        const { oscarApr, wethApr, stableApr } = isActive
          ? getFarmAprLocal(chainId, farm.lpAddress, totalLiquidity, new BigNumber(farm.tokenPriceBusd), new BigNumber(farm.quoteTokenPriceBusd), oscarPerSec)
          : { oscarApr: 0, wethApr: 0, stableApr: 0 }
        ...
        // return { ...farm, apr: monkRewardsApr, lpRewardsApr, liquidity: totalLiquidity }
      })
    ...
    [query, isActive, chainId, cakePrice, oscarPerSec],
  )
    ...
    <FarmsContext.Provider value={{ chosenFarmsMemoized }}>
      <PageHeader>
        <FarmFlexWrapper justifyContent="space-between">
          ...
          {/* {(chainId === ChainId.BSC_TESTNET || chainId === ChainId.GOERLI) && (
            <Box>
              <BCakeBoosterCard />
            </Box>
          )} */}
      ...
      <Page>
        {/* <Flex mt="20px" justifyContent="center">
          <FarmH2 scale="lg" color="text">
            {t('Stake LP & Earn 3D Reward ETH/OSCAR/DAI')}
          </FarmH2>{' '}
        </Flex> */}
          ...
          <FinishedTextContainer>
            ...
            <Flex>
              ...
              <FinishedTextLink
                ...
                href="https://v1-farms.app.RelymerDex.com/farms/history"
              >
        ...
        <StyledImage src="/images/logo.png" alt="RelymerDex illustration" width={120} height={103} />
      </Page>
