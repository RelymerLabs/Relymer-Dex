...
export const useBCakeTooltipContent = () => {
  ...
  const tooltipContent = (
    <>
      <Box mb="20px">
        {t(
          'Yield Boosters allow you to boost your farming yields by locking BNB in the fixed-term staking BNB pool. The more BNB you lock, and the longer you lock them, the higher the boost you will receive.',
        )}
      </Box>
    </>
  )
...
export const BCakeBoosterCard = () => {
  ...
  return (
    <CardWrapper>
      <ImageWrapper>
        <Image src="/images/v.png" alt="boosterCardImage" width={200} height={191}  />
      </ImageWrapper>
    ...
    return (
      <Box>
        ...
        <Text color="textSubtle" fontSize={12} mb="16px">
          {t('An active fixed-term BNB staking position is required for activating farm yield boosters.')}
        </Text>
