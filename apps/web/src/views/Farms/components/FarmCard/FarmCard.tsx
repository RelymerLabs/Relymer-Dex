...
const FarmCard: React.FC<React.PropsWithChildren<FarmCardProps>> = ({
  ...
  const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('RelymerDex', '')
  const earnLabel = farm.dual ? farm.dual.earnLabel : t('BNB')
  ...
  const isPromotedFarm = farm.token.symbol === 'ARB1'
    ...
    <StyledCard isActive={isPromotedFarm}>
      ...
      {farm?.pid === 1 ? (
        <DetailsSection
          ...
          lpLabel={lpLabel}
          addLiquidityUrl={chainId ===56? `https://pancakeswap.finance/`:`/add/ETH/0x912CE59144191C1204E64559FE8253a0e49E6548?chainId=42161`}
        ...
        <DetailsSection
          ...
          totalValueFormatted={totalValueFormatted}
          lpLabel={lpLabel}
          addLiquidityUrl={chainId ===56? `https://pancakeswap.finance/`:"https://www.sushi.com/pools/add/v2/42161"}
          isCommunity={farm.isCommunity}
          auctionHostingEndDate={farm.auctionHostingEndDate}
        />
      ) : (
