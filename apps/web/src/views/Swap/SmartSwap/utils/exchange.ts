...
import RoshiniSwapSmartRouterABI from 'config/abi/roshiniSwapSmartRouter.json'
import { RoshiniSwapSmartRouter } from 'config/abi/types/RoshiniSwapSmartRouter'
...
export const SMART_ROUTER_ADDRESS: ChainMap<string> = {
  [ChainId.ETHEREUM]: '',
  [ChainId.RINKEBY]: '',
  [ChainId.GOERLI]: '0x24117b78191BB02a4abEDfe1C7fa1Be559961D07',
  [ChainId.BSC]: '0x2f22e47CA7C5e07F77785f616cEeE80c5E84127C',
  [ChainId.BSC_TESTNET]: '0x871c1d1e428526300c8Fd36D6CdC721799fDE458',
}

export function useSmartRouterContract() {
  const { chainId } = useActiveChainId()
  return useContract<RoshiniSwapSmartRouter>(SMART_ROUTER_ADDRESS[chainId], RoshiniSwapSmartRouterABI, true)
}
