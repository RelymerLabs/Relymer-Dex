...
import { nftsBaseUrl, RoshiniBunniesAddress } from '../../constants'
...
const CollectibleLinkCard: React.FC<React.PropsWithChildren<CollectibleCardProps>> = ({
  ...
  const urlId = isAddress(nft.collectionAddress) === RoshiniBunniesAddress ? nft.attributes[0].value : nft.tokenId
  return (
