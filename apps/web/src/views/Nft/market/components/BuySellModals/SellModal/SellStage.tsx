...
import { nftsBaseUrl, RoshiniBunniesAddress } from 'views/Nft/market/constants'
...
const SellStage: React.FC<React.PropsWithChildren<SellStageProps>> = ({
  ...
  const itemPageUrlId =
    isAddress(nftToSell.collectionAddress) === RoshiniBunniesAddress ? nftToSell.attributes[0].value : nftToSell.tokenId
