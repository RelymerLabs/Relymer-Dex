...
export const useRoshiniBunnyOnSaleNfts = (
  bunnyId: string,
  nftMetadata: ApiResponseCollectionTokens,
  itemsPerPage: number,
) => {
  ...
  const {
    ...
    (pageIndex, previousPageData) => {
      ...
      return [bunnyId, direction, pageIndex, 'RoshiniBunnyOnSaleNfts']
    },
    async (id, sortDirection, page) => {
      ...
      const updatedMarketData = await getNftsUpdatedMarketData(RoshiniBunniesAddress.toLowerCase(), nftsMarketTokenIds)
