...
interface RoshiniBunniesTraitsProps {
...
const RoshiniBunniesTraits: React.FC<React.PropsWithChildren<RoshiniBunniesTraitsProps>> = ({ collectionAddress }) => {
...
export default RoshiniBunniesTraits
