...
interface MainRoshiniBunnyCardProps {
  cheapestNft: NftToken
  nothingForSaleBunny: NftToken
  onSuccessSale: () => void
}

const MainRoshiniBunnyCard: React.FC<React.PropsWithChildren<MainRoshiniBunnyCardProps>> = ({
  cheapestNft,
  nothingForSaleBunny,
  onSuccessSale,
}) => {
...
export default MainRoshiniBunnyCard
