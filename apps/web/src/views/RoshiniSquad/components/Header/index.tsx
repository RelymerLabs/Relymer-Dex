...
import { StyledWaveContainer } from 'views/RoshiniSquad/styles'
import { UserStatusEnum } from 'views/RoshiniSquad/types'
...
import {RoshiniSquadHeaderType} from './types'

const DEFAULT_CAKE_COST = 15
const DEFAULT_MAX_TICKETS = 10

const RoshiniSquadHeader: React.FC<React.PropsWithChildren<RoshiniSquadHeaderType>> = ({
  userInfos,
  eventInfos,
  account,
  userStatus,
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('RelymerDex’s first official generative NFT collection.')}
      </Text>
...
export default RoshiniSquadHeader
