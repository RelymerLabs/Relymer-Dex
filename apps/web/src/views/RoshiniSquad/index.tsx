...
import RoshiniSquadHeader from './components/Header'
import { RoshiniSquadContext } from './context'
...
const RoshiniSquad: React.FC<React.PropsWithChildren> = () => {
  ...
  return (
    <RoshiniSquadContext.Provider value={{ isUserEnabled, setIsUserEnabled }}>
