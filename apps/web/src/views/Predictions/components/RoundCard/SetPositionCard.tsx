...
const SetPositionCard: React.FC<React.PropsWithChildren<SetPositionCardProps>> = ({
  ...
  const { isVaultApproved, setLastUpdated } = useCakeApprovalStatus(token.symbol === 'AETH' ? predictionsAddress : null)
  ...
  const handleEnterPosition = async () => {
    ...
    const args = token.symbol === 'AETH' ? [epoch, valueAsBn.toString()] : [epoch]
