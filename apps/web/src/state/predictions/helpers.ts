...
export const transformBetResponse = (tokenSymbol) =>
  tokenSymbol === 'AETH' ? transformBetResponseCAKE : transformBetResponseBNB

export const transformUserResponse = (tokenSymbol) =>
  tokenSymbol === 'AETH' ? transformUserResponseCAKE : transformUserResponseBNB
...
export const getTotalWon = async (): Promise<{ totalWonBNB: number; totalWonCAKE: number }> => {
  ...
  const totalWonCAKE = getTotalWonMarket(CAKEMarket, 'AETH')
