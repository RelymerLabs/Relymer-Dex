...
import { scales, RoshiniToggleProps, HandleProps, InputProps, ScaleKeys } from "./types";

const scaleKeyValues = {
  sm: {
    pancakeSize: "14px", // The size of a roshini (the handle)
    ...
    pancakeThickness: "1px", // Bottom shadow of a roshini
    pancakeTwoOffset: "0px", // Pancakes don't look good when they are concentric
    pancakeThreeOffset: "-3px", // so roshini 2 and 3 are shifted a little bit
...
const getScale =
  (property: ScaleKeys) =>
  ({ scale = scales.LG }: RoshiniToggleProps) => {
...
export const PancakeLabel = styled.label<RoshiniToggleProps>`
