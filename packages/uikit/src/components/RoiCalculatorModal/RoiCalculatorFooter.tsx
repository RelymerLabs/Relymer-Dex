  ...
  const {
    ...
    <>
      <Text>
        {rewardCakePerSecond
          ? t(
              "The Multiplier represents the proportion of relymer rewards each farm receives, as a proportion of the relymer produced each second."
            )
          : t(
              "The Multiplier represents the proportion of relymer rewards each farm receives, as a proportion of the relymer produced each block."
            )}
      </Text>
      <Text my="24px">
        {rewardCakePerSecond
          ? t("For example, if a 1x farm received 1 relymer per second, a 40x farm would receive 40 relymer per second.")
          : t("For example, if a 1x farm received 1 relymer per block, a 40x farm would receive 40 relymer per block.")}
      </Text>
